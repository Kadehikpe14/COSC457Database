...
class Main {
    ...
    static void staffTable() {
        ...
        Object[][] data = {
                {12345,"Joyce", "Olaniyi", "443-000-0101", 1},
                {54321,"Anjita", "Bhandari","443-111-1357", 2},
                {67890,"Kadeh", "Ikpe",  "443-444-2468", 3},
                {12340,"Shane", "Strenne",  "443-333-1345", 4},
                {87654,"Naymar", "Junior",  "443-445-676",6}
        };
    ...
    static void clientTable() {
        ...
        Object[][] data = {
                {111111, "Jack", "Smith", "410-124-5267", null },
                {222222, "Random","Name", "443-337-8910", null},
                {123456,"Sarah", "Doe","123456", "667-123-9876", 1 },
                {987654,"Amy", "Patrick", "987654","667-321-5432", 2},
                {246801,"Gold", "Eve","543210", "667-213-1367", 3},
                {137931,"Asmita", "Smith", "876540", "667-090-9115", 4}
        };
        JTable table = new JTable(data, columnNames);
        JScrollPane scrollPane = new JScrollPane(table);
        table.setFillsViewportHeight(true);
    ...
    static void servicesTable() {
        ...
        Object[][] data = {
                {"Bratzdoll Full Glam","foundation ", "Joyce", 90},
                {"Marylin Soft Glam","Eyeline", "Joyce", 65},
